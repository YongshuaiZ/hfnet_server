...
default_config = {
    'cpu_extension': "/opt/intel/openvino_2021/inference_engine/lib/intel64/libinference_engine_c_api.so",
    'model_path': '/home/zhu/SlamProjects/hfnet_ws/src/deep_features/models/hfnet_vino',
